...
::: {.alert .alert-warning}
<strong>Exercício 3</strong> Os dados abaixo representam os óbitod por suicídios no Mato Grosso do Sul. O banco de dados utilizado é dado a seguir. Construa uma série mensal e estude seu comportamento
